...
#  export PARMETIS_ROOT=~/lib/static/64-bit/parmetis-4.0.3 
  ...
  cmake .. \
    ...
    -DCMAKE_C_FLAGS="-std=c99 -O3 -DDEBUGlevel=0 -DPRNTlevel=2 -DOPT_CPU_UPANEL_TRSM -DOPT_GPU_LPANEL_TRSM -DOPT_GPU_UPANEL_TRSM -DOPT_GATHER_AVOID -DOPT_SCATTER" \
    ...
    -DCMAKE_CUDA_FLAGS="-O3 -DOPT_GATHER_AVOID -DOPT_CPU_UPANEL_TRSM -DOPT_GPU_UPANEL_TRSM -DMULTI_GPU -I/share/home/wanghongyu/spack/opt/spack/linux-centos7-haswell/gcc-4.8.5/mpich-4.0.2-kaz3kvkaicme5wnjgd6zavsee2ybqkoa/include" \
