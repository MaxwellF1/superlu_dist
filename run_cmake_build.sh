...
#  export PARMETIS_ROOT=~/lib/static/64-bit/parmetis-4.0.3 
  ...
  cmake .. \
    ...
    -DCMAKE_C_FLAGS="-I/usr/local/cuda/include -std=c99 -O3 -DDEBUGlevel=0 -DPRNTlevel=2 -DOPT_CPU_UPANEL_TRSM -DOPT_GATHER_AVOID -DOPT_SCATTER" \
    -DCMAKE_C_COMPILER=mpicc \
    -DCMAKE_CXX_COMPILER=mpicxx \
    -DCMAKE_CXX_FLAGS="-std=c++11 -O3 -L/usr/local/cuda/lib64 -lcudart -lcudadevrt -lcublas -lnvToolsExt -DPRNTlevel=0" \
    -DCMAKE_Fortran_COMPILER=mpif90 \
    -DCMAKE_Fortran_FLAGS="-I/usr/local/include -L/usr/local/cuda/lib64 -lcuda -lcudart -lcudadevrt -lcublas -lnvToolsExt" \
    ...
    -DCMAKE_CUDA_FLAGS="-O3 -lnvToolsExt -DOPT_GATHER_AVOID -DOPT_CPU_UPANEL_TRSM -DOPT_GPU_UPANEL_TRSM -I/share/home/wanghongyu/spack/opt/spack/linux-centos7-haswell/gcc-4.8.5/mpich-4.0.2-kaz3kvkaicme5wnjgd6zavsee2ybqkoa/include" \
...
#
   # -DCMAKE_C_FLAGS="-I/usr/local/cuda/include -std=c99 -O3 -DDEBUGlevel=0 -DPRNTlevel=2 -DOPT_CPU_UPANEL_TRSM -DOPT_SCATTER -DOPT_GATHER_AVOID -DOPT_ZGEMM_ON_GPU" \
# make VERBOSE=1
# make test
